...
<head>
	...
	<link rel="stylesheet" href="css/snapPage.css">
	<script src="view/menu.js"></script>
	<script src="view/snapPage.js"></script>
...
<body>
	<div id="wrapper">
		...
		<div class="categoryTitle">Snapshot page</div>
		<div id="errorMessage"><?php if (isset($_SESSION['last_error'])) {echo $_SESSION['last_error']; $_SESSION['last_error'] = '';} ?></div>
		<section id="snap">
			<img id="snapImg">
			<textarea id="commentField" placeholder="Your new comment"></textarea>
			<input type="submit" value="Comment" id="submit" onclick="addComment()">
		</section>
